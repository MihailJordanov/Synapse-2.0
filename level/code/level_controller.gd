...
func _generate_decks() -> void:
	var player_card_ids: Array[int] = [21100, 11008, 11007, 11003, 11004, 11009, 21101, 11007, 11008, 21102]
	var enemy_card_ids: Array[int] = [11009, 21100, 11007, 21100, 11005, 11002, 21100, 11007, 11001, 21101]
